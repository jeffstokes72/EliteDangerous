...
+ The "Last Market" column displays a check mark if the commodity is for sale at the last commodity market you accessed.
...
+ Settings are available in the E:D Market Connector under File menu->Settings->ArchitectTracker tab
