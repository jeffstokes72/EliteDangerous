...
**Recommended:** download <a href="https://github.com/jeffstokes72/EliteDangerous/releases/latest">ArchitectTracker 2.4</a> (`ArchitectTracker-2.4.zip`). That zip has `load.py` at the root — extract it straight into the `ArchitectTracker` plugins folder.
...
mkdir -p "$PLUGIN_DIR"
cd /tmp
curl -L -o ArchitectTracker-2.4.zip https://github.com/jeffstokes72/EliteDangerous/releases/download/v2.4/ArchitectTracker-2.4.zip
unzip -o ArchitectTracker-2.4.zip -d "$PLUGIN_DIR"
...
**Manual / zip install**
1. Download <a href="https://github.com/jeffstokes72/EliteDangerous/releases/latest">ArchitectTracker-2.4.zip</a> (or clone this repo).
...
+ 2026/08/10 : [Version 2.4] Overlay list is a spaced two-column table: Commodity | Needed.
